...
export const TopoBackground = () => {
  return (
    <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden bg-app-bg transition-colors duration-300">
      ...
      {/* 1. Macro Terrain Depth Layer — CSS blur instead of SVG filter (iOS Safari compat) */}
      <div className="absolute inset-0 opacity-[0.06] dark:opacity-[0.04]">
        ...
        >
          <ellipse cx="200" cy="200" rx="500" ry="400" className="fill-current text-text-muted" />
          <ellipse cx="1300" cy="800" rx="600" ry="500" className="fill-current text-text-muted" />
          <ellipse cx="800" cy="1000" rx="700" ry="300" className="fill-current text-text-muted" />
        </svg>
      </div>
